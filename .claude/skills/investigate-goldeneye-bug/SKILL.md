...
Read and follow the shared skill instructions at
`.agents/skills/investigate-goldeneye-bug/SKILL.md`, relative to the repository root
([link](../../../.agents/skills/investigate-goldeneye-bug/SKILL.md)), before taking action.

Read repository-wide Claude guidance in `CLAUDE.md`. When the shared instructions mention a skill
using `$skill-name`, invoke the corresponding `/skill-name` command in Claude Code.
