...
for p in 0001-source 0006-fov-live-setter 0007-load-trace \
         ...
         0025-cuff-native-pointer-stride 0026-bloodier-gibs 0027-external-rom-path 0028-prop-allocator-telemetry 0029-modern-mouse-look 0030-autocrouch-render-ticks 0031-native-joy-poll-handshake; do
