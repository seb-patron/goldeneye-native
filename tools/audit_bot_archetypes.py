...
⚠️ REQUIREMENTS ARE INFERRED FROM THE ARCHETYPE'S OWN FIELDS, not hand-assigned per level. A
...
⚠️ AND A FAILED CHECK IS A FACT ABOUT THE PAIRING, NOT A DEFECT IN EITHER. "PeaceSim is unplayable
...
def satisfies(shape, need):
    ...
    #
    # ⚠️ THE PROXIES THEY REPLACE WERE MEASURING THE WRONG QUANTITY, which is why they are gone
