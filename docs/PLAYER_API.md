...
**Unresolved and necessary.** Two mechanisms decouple simulation from rendering and the
...
- ViZDoom uses a *software* renderer because at the resolutions RL actually uses
